...
{{--        </button>--}}
        ...
        <div class="flex md:flex-row flex-col h-full w-full">
            ...
            {{--  Sidenav  --}}
            <div id="mySidenav" class="sidenav bg-gray-600 flex flex-col md:w-full lg:w-[300px] md:h-full h-[60%] lg:block top-0 left-0 overflow-y-hidden lg:overflow-x-auto pt-[35px]">
{{--            <a href="javascript:void(0)" class="closebtn lg:hidden" onclick="closeNav()">&times;</a>--}}
                ...
                @foreach ($teachers AS $teacher)
                    <div  class="click-teacher cursor-pointer flex items-center md:flex-row flex-col md:w-auto min-w-[190px] md:h-auto h-[200px] mx-2 mt-5 py-3 px-3 block mx-auto rounded-md bg-slate-800 leading-3 " data-id="{{ $teacher->id }}">

                        <img src="{{ '/storage/' . $teacher->picture   }}" class="min-h-[60px] w-[60px] min-h-[60px] h-[60px] rounded-full bg-gray-100"/>
                        ...
                        <div class="md:mt-0 mt-3 h-full pl-2 text-white ">
                            ...
                            @else
                                <h1 class="text-sm pr-1">Onbekend</h1>
                            @endif
                        </div>
                    </div>
                @endforeach
        ...
        <div class="flex flex-col h-full w-full">
            <div class="h-full w-full flex justify-center items-center bg-gray-200">
                @csrf
                    <div id="mapid" class="center-block  md:w-[80%] w-full h-[70%] bg-white">
